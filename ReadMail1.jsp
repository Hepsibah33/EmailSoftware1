...
<form name="f1" action="DeleteMail1.jsp">
...
<tr><td></td><td><br><br><input type=submit value="Delete" class="myButton"></form><form name=f2 action=inbox.jsp><input type=submit value="Back" class="myButton"></td></tr>

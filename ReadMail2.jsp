...
<form name="f1" action="DeleteMail2.jsp">
...
<tr><td></td><td><br><br><input type=submit value="Delete" class="myButton"></form><form name=f2 action=SentBox.jsp><input type=submit value="Back" class="myButton"></td></tr>

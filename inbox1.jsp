...
<table border=1 width="90%" align=center><tr><td align=center><a href="inbox1.jsp">Inbox</a></td><td align=center><a href="sentBox.jsp">Sentbox</a></td><td align=center><a href="composeMail.jsp">ComposeMail</a></td><td align=center><a href="logout_1.jsp">Logout</a></td></tr></table><br><br>
...
String sql ="select * from mails where mto='"+user_id+"' and inbox1=1";
